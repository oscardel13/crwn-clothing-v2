...
export type SignInSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_IN_SUCCESS,UserWithID>
export type SignInFailed = ActionWithPayload<USER_ACTION_TYPES.SIGN_IN_FAILED,Error>
export type SignUpStart = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_START,SignUpStartProps>
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS,{user: User; additionalDetails?: AdditionalInfromation}>
...
export const signInSuccess = withMatcher((user: UserWithID):SignInSuccess => {
